# Government Orders Search System
...
(venv name can be changed as preferred)
...
#### 4.1 Redis Stack startup script
...
- Filename is clickable (inline preview / open)
...
- Always use relative paths + Streamlit rendering
